...
namespace Gym_Management_system {
    ...
    public partial class Database1DataSet3 : global::System.Data.DataSet {
        ...
        public partial class CustomerDataTable : global::System.Data.TypedTableBase<CustomerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CustomerRow AddCustomerRow(string Username, string Fullname, int Age, string Email, string Password, string PostCode, string Sex, string ContactNumber) {
...
namespace Gym_Management_system.Database1DataSet3TableAdapters {
    ...
    public partial class CustomerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Customer] WHERE (([CustomerID] = @Original_CustomerID) AND ([Username] = @Original_Username) AND ([Fullname] = @Original_Fullname) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)) AND ([Email] = @Original_Email) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_PostCode = 1 AND [PostCode] IS NULL) OR ([PostCode] = @Original_PostCode)) AND ((@IsNull_Sex = 1 AND [Sex] IS NULL) OR ([Sex] = @Original_Sex)) AND ([ContactNumber] = @Original_ContactNumber))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Customer] ([Username], [Fullname], [Age], [Email], [Password], [PostCode], [Sex], [ContactNumber]) VALUES (@Username, @Fullname, @Age, @Email, @Password, @PostCode, @Sex, @ContactNumber);
SELECT CustomerID, Username, Fullname, Age, Email, Password, PostCode, Sex, ContactNumber FROM Customer WHERE (CustomerID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customer] SET [Username] = @Username, [Fullname] = @Fullname, [Age] = @Age, [Email] = @Email, [Password] = @Password, [PostCode] = @PostCode, [Sex] = @Sex, [ContactNumber] = @ContactNumber WHERE (([CustomerID] = @Original_CustomerID) AND ([Username] = @Original_Username) AND ([Fullname] = @Original_Fullname) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)) AND ([Email] = @Original_Email) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_PostCode = 1 AND [PostCode] IS NULL) OR ([PostCode] = @Original_PostCode)) AND ((@IsNull_Sex = 1 AND [Sex] IS NULL) OR ([Sex] = @Original_Sex)) AND ([ContactNumber] = @Original_ContactNumber));
SELECT CustomerID, Username, Fullname, Age, Email, Password, PostCode, Sex, ContactNumber FROM Customer WHERE (CustomerID = @CustomerID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerID, Username, Fullname, Age, Email, Password, PostCode, Sex, Conta" +
                "ctNumber FROM dbo.Customer";
        ...
        public virtual int Fill(Database1DataSet3.CustomerDataTable dataTable) {
        ...
        public virtual Database1DataSet3.CustomerDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet3.CustomerDataTable dataTable = new Database1DataSet3.CustomerDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet3.CustomerDataTable dataTable) {
        ...
        public virtual int Delete(int Original_CustomerID, string Original_Username, string Original_Fullname, global::System.Nullable<int> Original_Age, string Original_Email, string Original_Password, string Original_PostCode, string Original_Sex, string Original_ContactNumber) {
        ...
        public virtual int Insert(string Username, string Fullname, global::System.Nullable<int> Age, string Email, string Password, string PostCode, string Sex, string ContactNumber) {
            if ((Username == null)) {
        ...
        public virtual int Update(
                    ...
                    string Original_Sex, 
                    string Original_ContactNumber) {
            return this.Update(Username, Fullname, Age, Email, Password, PostCode, Sex, ContactNumber, Original_CustomerID, Original_Username, Original_Fullname, Original_Age, Original_Email, Original_Password, Original_PostCode, Original_Sex, Original_ContactNumber, Original_CustomerID);
        }
    }
