...
namespace Gym_Management_system {
    ...
    public partial class Database1DataSet2 : global::System.Data.DataSet {
        ...
        public partial class ClassesDataTable : global::System.Data.TypedTableBase<ClassesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ClassesRow AddClassesRow(string ClassName, int InstructorID, System.DateTime ClassDate, System.TimeSpan StartTime, int Duration, int Capacity) {
        ...
        public partial class ClassesRow : global::System.Data.DataRow {
            ...
            public System.DateTime ClassDate {
                get {
                    return ((global::System.DateTime)(this[this.tableClasses.ClassDateColumn]));
                }
                set {
                    this[this.tableClasses.ClassDateColumn] = value;
                }
            }
            ...
            public int Duration {
                get {
                    return ((int)(this[this.tableClasses.DurationColumn]));
                }
                set {
                    this[this.tableClasses.DurationColumn] = value;
                }
            }
            ...
            public int Capacity {
                get {
                    return ((int)(this[this.tableClasses.CapacityColumn]));
                }
                set {
...
namespace Gym_Management_system.Database1DataSet2TableAdapters {
    ...
    public partial class ClassesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Classes] WHERE (([ClassID] = @Original_ClassID) AND ([ClassName] = @Original_ClassName) AND ([InstructorID] = @Original_InstructorID) AND ([ClassDate] = @Original_ClassDate) AND ([StartTime] = @Original_StartTime) AND ([Duration] = @Original_Duration) AND ([Capacity] = @Original_Capacity))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Classes] ([ClassName], [InstructorID], [ClassDate], [StartTime], [Duration], [Capacity]) VALUES (@ClassName, @InstructorID, @ClassDate, @StartTime, @Duration, @Capacity);
SELECT ClassID, ClassName, InstructorID, ClassDate, StartTime, Duration, Capacity FROM Classes WHERE (ClassID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Classes] SET [ClassName] = @ClassName, [InstructorID] = @InstructorID, [ClassDate] = @ClassDate, [StartTime] = @StartTime, [Duration] = @Duration, [Capacity] = @Capacity WHERE (([ClassID] = @Original_ClassID) AND ([ClassName] = @Original_ClassName) AND ([InstructorID] = @Original_InstructorID) AND ([ClassDate] = @Original_ClassDate) AND ([StartTime] = @Original_StartTime) AND ([Duration] = @Original_Duration) AND ([Capacity] = @Original_Capacity));
SELECT ClassID, ClassName, InstructorID, ClassDate, StartTime, Duration, Capacity FROM Classes WHERE (ClassID = @ClassID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ClassID, ClassName, InstructorID, ClassDate, StartTime, Duration, Capacity" +
                " FROM dbo.Classes";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT ClassID, ClassName, InstructorID, ClassDate, StartTime, Duration, Capacity" +
                " FROM dbo.Classes";
        ...
        public virtual int Fill(Database1DataSet2.ClassesDataTable dataTable) {
        ...
        public virtual Database1DataSet2.ClassesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet2.ClassesDataTable dataTable = new Database1DataSet2.ClassesDataTable();
        ...
        public virtual int FillBy(Database1DataSet2.ClassesDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet2.ClassesDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ClassID, string Original_ClassName, int Original_InstructorID, System.DateTime Original_ClassDate, System.TimeSpan Original_StartTime, int Original_Duration, int Original_Capacity) {
        ...
        public virtual int Insert(string ClassName, int InstructorID, System.DateTime ClassDate, System.TimeSpan StartTime, int Duration, int Capacity) {
            if ((ClassName == null)) {
        ...
        public virtual int Update(string ClassName, int InstructorID, System.DateTime ClassDate, System.TimeSpan StartTime, int Duration, int Capacity, int Original_ClassID, string Original_ClassName, int Original_InstructorID, System.DateTime Original_ClassDate, System.TimeSpan Original_StartTime, int Original_Duration, int Original_Capacity, int ClassID) {
            if ((ClassName == null)) {
                throw new global::System.ArgumentNullException("ClassName");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[9].Value = ((System.DateTime)(Original_ClassDate));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ClassName, int InstructorID, System.DateTime ClassDate, System.TimeSpan StartTime, int Duration, int Capacity, int Original_ClassID, string Original_ClassName, int Original_InstructorID, System.DateTime Original_ClassDate, System.TimeSpan Original_StartTime, int Original_Duration, int Original_Capacity) {
            return this.Update(ClassName, InstructorID, ClassDate, StartTime, Duration, Capacity, Original_ClassID, Original_ClassName, Original_InstructorID, Original_ClassDate, Original_StartTime, Original_Duration, Original_Capacity, Original_ClassID);
        }
    }
